...
async function generateJWT(options) {
  const { SignJWT } = await import("./esm-FVRLDW4P.mjs");
...
async function randomUUID() {
  const { randomUUID: randomUUID2 } = await import("./crypto.node-GBY33BCU.mjs");
  return randomUUID2();
}
__name(randomUUID, "randomUUID");
async function digestSHA256(data) {
  const { subtle: subtle2 } = await import("./crypto.node-GBY33BCU.mjs");
...
async function loadSuperJSON() {
  const superjson = await import("./dist-TV7S55F3.mjs");
...
@google-cloud/precise-date/build/src/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OJNBOWJS.mjs.map
